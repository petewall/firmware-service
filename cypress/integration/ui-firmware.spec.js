...
//   beforeEach(() => {
//     cy.request('PUT', 'http://localhost:5000/api/firmware/firmware-a/1.0.0')
//     cy.request('PUT', 'http://localhost:5000/api/firmware/firmware-c/0.0.1')
//     cy.request('PUT', 'http://localhost:5000/api/firmware/firmware-a/0.0.1')
//     cy.request('PUT', 'http://localhost:5000/api/firmware/firmware-b/0.20.1')
//     cy.request('PUT', 'http://localhost:5000/api/firmware/firmware-b/0.2.1')
//   })
...
//     cy.intercept('http://localhost:5000/api/firmware').as('firmwareRequest')
//     cy.visit('http://localhost:5000/#/firmware')
...
//   beforeEach(() => {
//     cy.request('DELETE', 'http://localhost:5000/api/firmware/firmware-d/1.2.3')
//   })
...
//       cy.request('PUT', 'http://localhost:5000/api/firmware/firmware-d/1.2.3')
//       cy.wait('@firmwareRequest')
